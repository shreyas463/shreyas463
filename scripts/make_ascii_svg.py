...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">shreyas463@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'shreyas463@github:~$ whoami <tspan fill="{INK}">Shreyas Chaudhary</tspan></text>')
parts.append(f'<rect x="{PAD+356}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
