...
# ===========================================================================
HOST = "shreyas463"   # shown as  shreyas463@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "SDE @ GlobalLogic × Walgreens (RxI)"),
    ("kv", "Prev", "Full-Stack Intern @ Method, Inc."),
    ("kv", "Also", "AV / CV researcher @ Cal Poly Pomona"),
    ("kv", "Edu", "M.S. CS, Cal Poly Pomona '25 — 4.0 GPA"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Next.js, TypeScript"),
    ("kv", "Backend", "Java, Node.js, Express, REST"),
    ("kv", "AI / ML", "PyTorch, YOLO, CNNs, Gemini"),
    ("kv", "Cloud", "Azure, GCP, Firebase, Databricks"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Ships pharmacy systems for 8,000+ Walgreens stores"),
    ("bul", "4 peer-reviewed publications (AV, DL, CV)"),
    ("bul", "Cut tech-discovery time 60% for a 500-eng org"),
]
